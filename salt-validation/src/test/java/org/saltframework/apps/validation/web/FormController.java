...
public class FormController {
	...
	@PostMapping
	@ResponseBody
	public org.saltframework.core.handlers.SuccessHandler ajaxPost(@Validated @RequestBody Form form, BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
