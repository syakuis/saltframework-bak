package org.saltframework.validation;
...
public class ValidationAspect {
	...
	@Around("pointTarget() && (execution(public * *(@org.saltframework.validation.Validation (*))) || execution(public * *(.., @org.saltframework.validation.Validation (*))) || execution(public * *(@org.saltframework.validation.Validation (*), ..)) || execution(public * *(.., @org.saltframework.validation.Validation (*), ..)))")
