...
import org.saltframework.boot.config.enums.Profile;
...
public class InitializingConfigureProperties {
	...
	public void afterPostProcessor() {
		...
		try {
			...
			this.salt = new Salt(properties, timeZone, locale);
			intro(properties);
		} catch (IOException e) {
	...
	private void intro(Properties properties) {
		...
		.append("                                                  version " + salt.getVersion())
		.append("\n                                                                         \n")
		.append("                                                                         \n")
		...
		.append("* Locale: ").append(salt.getLocale().getLanguage()).append("\n")
		.append("* TimeZone: ").append(salt.getTimeZone().getID()).append("\n")
		.append("* Date: ").append(new Date()).append("\n")
		.append("* Encoding: ").append(salt.getCharset()).append("\n")
		.append("* Profile: ").append(salt.getProfile()).append("\n")
